...
urlpatterns = [
    ...
    path ('week/graph/', views.Graph_weeks.as_view(), name ="week_graph" ), 
    ...
    path ('log/graph/<int:pk>/', views.Graph_lake.as_view(), name ="log_graph_lake" ),
    ...
    path ('videos/new/<str:field>/<int:pk>/', VideoCreateView.as_view(), name = 'video_create'),
    path ('videos/new/<str:field>/<int:pk>/<str:tag>/', VideoCreateView.as_view(), name = 'video_create'),
    ...
    path ('articles/new/<str:field>/<int:pk>/', ArticleCreateView.as_view(), name = 'article_create'),
    path ('articles/new/<str:field>/<int:pk>/<str:tag>/', ArticleCreateView.as_view(), name = 'article_create'),
    ...
    path ('pictures/new/',              PictureCreateView.as_view(),        name = 'picture_create'),
    path ('pictures/new/<str:field>/<int:pk>/', PictureCreateView.as_view(), name = 'picture_create'),
    path ('pictures/new/<str:field>/<int:pk>/<str:tag>/', PictureCreateView.as_view(), name = 'picture_create'),
    ...
    path ('media/unlink/<str:field>/<int:pk>/<str:media_type>/<int:media_pk>/', views.unlink_media_from_item, name='unlink_media_from_item'), 
